...
export const GamingParentContainer = Styled.div`
    height: 100vh;
    width: 100%;
    padding: 0px;
    display: flex;
    ...
    background-color: ${props =>
      props.selectedTheme === 'LIGHT' ? '#f9f9f9' : '#0f0f0f'};
    @media screen and (max-width: 767px) {
        flex-direction: column;
    }
`
export const GamingSideMenuForSmallDevice = Styled.div`
    height: 70vh;
    width: 100%;
    flex-shrink: 0;
...
export const GamingSideMenuForLargeDevice = Styled.div`
    height: 100%;
    width: 20%;
     flex-shrink: 0;
    @media screen and (max-width: 767px) {
