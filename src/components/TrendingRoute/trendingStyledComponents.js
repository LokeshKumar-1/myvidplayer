...
export const TrendingParentContainer = Styled.div`
    height: 100vh;
    width: 100%;
    padding: 0px;
    display: flex;
...
`
export const TrendingSideMenuForSmallDevice = Styled.div`
    height: 70vh;
    width: 100%;
    flex-shrink: 0;
...
export const TrendingSideMenuForLargeDevice = Styled.div`
    height: 100%;
    width: 20%;
     flex-shrink: 0;
    @media screen and (max-width: 767px) {
